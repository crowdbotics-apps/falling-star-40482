"""
Django settings for falling_star_40482 project.
...
ROOT_URLCONF = 'falling_star_40482.urls'
...
WSGI_APPLICATION = 'falling_star_40482.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_star_40482 API",
    "DESCRIPTION": "API documentation for falling_star_40482 App",
    "VERSION": "v1",
}
